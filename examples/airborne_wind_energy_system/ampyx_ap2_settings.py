...
def set_ampyx_ap2_settings(options, dof):
    ...
    # variable bounds
    options['model.system_bounds.x.l_t'] =  [-ca.inf, ca.inf]#[10.0, 700.0] # [m]
    ...
    if dof == 6:
        options['model.system_bounds.theta.t_f'] = [1.0, 70.0] # [s]
    else:
        options['model.system_bounds.theta.t_f'] = [1.0, 15.0] # [s]

    options['model.system_bounds.z.lambda'] =  [-ca.inf, ca.inf] # [N/m]
    ...
    options['solver.initialization.l_t'] = 300.
    if dof == 3:
        options['solver.initialization.theta.diam_t'] = 2e-3
